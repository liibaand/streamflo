...
export async function registerRoutes(app: Express): Promise<Server> {
      ...
      if (videos.length === 0 && offset === 0) {
        ...
        const sampleVideos = [
          ...
          },
          {
            ...
            description: 'Breaking down the hottest tech releases this month. Which one should you buy?',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=4',
            duration: 18,
            hashtags: ['tech', 'review', 'gadgets'],
            musicInfo: 'Tech Vibes - Electronic',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            ...
            description: 'Final day of my 30-day fitness transformation! The results are incredible.',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=5',
            duration: 22,
            hashtags: ['fitness', 'transformation', 'motivation'],
            musicInfo: 'Workout Energy - Pump Up',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            ...
            description: 'Creating a masterpiece in 60 seconds. The final result will blow your mind!',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=6',
            duration: 16,
            hashtags: ['art', 'timelapse', 'creative'],
            musicInfo: 'Creative Flow - Ambient',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            userId: currentUser,
            title: 'Pet Comedy Gold',
            description: 'My cat thinks he owns the house... and honestly, he might be right 😂',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=7',
            duration: 14,
            hashtags: ['pets', 'funny', 'cats'],
            musicInfo: 'Comedy Central - Upbeat',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            ...
            description: 'Trying the most exotic street food in Bangkok. Some of these are... interesting.',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=8',
            duration: 19,
            hashtags: ['food', 'travel', 'streetfood'],
            musicInfo: 'World Flavors - Cultural',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            ...
            description: 'Getting through finals week with coffee and determination. We got this!',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=9',
            duration: 13,
            hashtags: ['study', 'college', 'motivation'],
            musicInfo: 'Study Lofi - Chill Beats',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            ...
            description: 'Turning thrift store finds into designer looks. Sustainable fashion is the future!',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=10',
            duration: 25,
            hashtags: ['fashion', 'sustainable', 'diy'],
            musicInfo: 'Fashion Forward - Stylish',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            userId: currentUser,
            title: 'Morning Routine Goals',
            description: 'How I start my day for maximum productivity. This changed everything for me.',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/VolkswagenGTIReview.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=11',
            duration: 17,
            hashtags: ['productivity', 'morning', 'lifestyle'],
            musicInfo: 'Morning Energy - Fresh Start',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          },
          {
            ...
            description: 'Best gaming moments from this week. That final clutch was unbelievable!',
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4',
            thumbnailUrl: 'https://picsum.photos/400/600?random=12',
            duration: 21,
            hashtags: ['gaming', 'highlights', 'clutch'],
            musicInfo: 'Game On - Electronic Rock',
            isPrivate: false,
            allowComments: true,
            allowDownloads: true
          }
  ...
  // Stripe webhook for coin purchases
  app.post('/api/webhooks/stripe', express.raw({ type: 'application/json' }), async (req, res) => {
    try {
      ...
      if (event.type === 'checkout.session.completed') {
        ...
        await storage.updateUserCoins(userId, parseInt(coinAmount));
